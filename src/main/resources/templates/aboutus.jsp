...
<body>
    ...
    <div class="container">
        ...
        <div class="team-member">
            ...
            <div class="team-member-details">
                <h3>Yarlagadda Sri</h3>
                <p>Team Lead</p>
            </div>
        </div>
        <div class="team-member">
            <img src="" alt="B.Goda Deepika">
            <div class="team-member-details">
                <h3>B.Goda Deepika</h3>
                <p>Team member</p>
            </div>
        </div>
        <div class="team-member">
            <img src="" alt="A.Lakkshmi">
            <div class="team-member-details">
                <h3>A.Lakkshmi</h3>
                <p>Team member</p>
            </div>
    ...
    <footer>
        <p>&copy; SDPJFSD07 Services. All rights reserved.</p>
    </footer>
</body>
</html>